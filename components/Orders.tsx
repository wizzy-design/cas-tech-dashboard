  ...
  return (
    <section className="shadow-md rounded-lg px-6 py-6">
      ...
      <div className="pt-8 space-y-2">
        <Order title="$2400, Design changes" icon={bell} date="22 DEC 7:20 PM"/>
        <Order title="New order #4219423" icon={css} date="21 DEC 11:21 PM"/>
        <Order title="Server Payments for April" icon={cart} date="21 DEC 9:28 PM"/>
        <Order title="New card added for order #3210145" icon={card} date="20 DEC 3:52 PM"/>
        <Order title="Unlock packages for Development" icon={dropbox} date="19 DEC 11:35 PM"/>
